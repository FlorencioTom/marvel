...
export class EventosComponent implements OnInit {
  ...
  ngOnInit(){
    ...
    if(this.atrasService.filterText != null && this.atrasService.filterText != ''){
      ...
      this.marvelService.getEventsByName(this.currentPageIndex, this.rows, this.atrasService.filterText).subscribe(response => {
  ...
  goToEvent(id: number): void {
    this.atrasService.setBackInfo(this.currentPageIndex, 'eventos', this.name, this.total);
