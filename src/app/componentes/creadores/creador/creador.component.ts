...
export class CreadorComponent {
  ...
  public getUriResults(){
    this.marvelService.getUriInfo(this.creator.comics.collectionURI);
  }
  ...
  public async handleComics() {
    ...
    if (this.arrComics.length === 0) {
      ...
      try {
        ...
        if(this.arrComics.length === 0){
          this._snackBar.open('La api de marvel no da comics de este creador', 'OK', {
            duration: 3000
          });
        } 
      }
  ...
  public async handleSeries() {
    ...
    if (this.arrSeries.length === 0) {
      ...
      try {
        ...
        if(this.arrSeries.length === 0){
          this._snackBar.open('La api de marvel no da series de este creador', 'OK', {
            duration: 3000
          });
        } 
      }
  ...
  public async handleEvents() {
    ...
    if (this.arrEvents.length === 0) {
      ...
      try {
        ...
        if(this.arrEvents.length === 0){
          this._snackBar.open('La api de marvel no da eventos de este creador', 'OK', {
            duration: 3000
          });
        } 
      }
