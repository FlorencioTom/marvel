...
export class ComicsComponent implements OnInit  {
  ...
  ngOnInit() {
    ...
    if(this.atrasService.filterText != null && this.atrasService.filterText != ''){
      ...
      this.marvelService.getComicsByTitle(this.currentPageIndex, this.rows, this.atrasService.filterText).subscribe(response => {
  ...
  goToComic(id: number): void {
    this.atrasService.setBackInfo(this.currentPageIndex, 'comics', this.name, this.total);
